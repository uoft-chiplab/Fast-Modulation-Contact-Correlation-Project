...
# find data files and read parameters
...
fields, times = np.unique(np.loadtxt(glob(f"{runpath}commands/incremental.txt*")[0],
                   delimiter=" ", usecols=[4, 5]), axis=0).T
