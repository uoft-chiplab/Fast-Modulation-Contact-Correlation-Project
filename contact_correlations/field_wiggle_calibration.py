...
def inv_a_amp_from_Vpp(B_eq, Vpp, freq):
    """
    Calculate the inverse scattering length amplitude (delta inv_a) from the voltage peak-to-peak (Vpp) and frequency (freq).
